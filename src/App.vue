...
<template>
    ...
    <footer
        class="container px-2 md:px-4 xl:px-20 2xl:px-40 pt-8 pb-20 flex flex-col sm:flex-row justify-between items-center text-gray-400 border-t border-gray-800 font-semibold">
        <div class="mb-2">
